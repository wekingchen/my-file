...
#	Author:	Chikage
#	Caddy+Aria2+Rclone+Sharelist+AriaNg
# ====================================================
...
domain_check(){
	stty erase '^H' && read -p "请输入你的ShareList域名信息(eg:pan.94ish.me):" domain 
...
wget "https://raw.githubusercontent.com/wekingchen/my-file/master/Aria2-Rclone-Sharelist-Aria2Ng/dht.dat"
wget "https://raw.githubusercontent.com/wekingchen/my-file/master/Aria2-Rclone-Sharelist-Aria2Ng/trackers-list-aria2.sh"
...
stty erase '^H' && read -p "请输入你的ShareList管理密码:" passsharelist
}

init_install(){
echo -e "${GreenBG} 开始配置自启 ${Font}"
wget --no-check-certificate https://raw.githubusercontent.com/wekingchen/my-file/master/Aria2-Rclone-Sharelist-Aria2Ng/aria2 -O /etc/init.d/aria2
...
sed -i "25i\curl  --data \"a=clear_cache\" \"http://127.0.0.1:33001/manage/api/${passsharelist}\"" autoupload.sh
